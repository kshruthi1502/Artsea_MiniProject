					...
					int flag=0;
					 Connection con;
						...
						try {
							...
							rs = s.executeQuery("select c_id,c_name,c_phone,c_address from customer");
							...
							if(flag==0)
							{
								Display.setText("Entered c_id doesn't exist try Again !");	
	
							}
							else
							{
								String query="DELETE FROM customer  WHERE c_id ="+tid.getText()+"";
